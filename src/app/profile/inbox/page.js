    ...
    <div className="min-h-[calc(100vh-5rem)] bg-gradient-to-b from-secondary/60 to-white pb-24 md:pb-8">
      <div className="px-4 pt-4">
        ...
        <p className="text-sm text-gray-600 mt-1 max-w-xl">
          Chat first, agree on a price, then send an offer. Once accepted, work
          ...
          conversations.map((c) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-3 rounded-xl border border-hash/25 bg-white p-3 hover:border-primary/40 hover:shadow-sm transition"
              >
                <Image
